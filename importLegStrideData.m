...
%
%    /Users/Michelle/Research/data/__DATA_ANALYSIS/_ALL_DATA/_Results/_LegsStridesCompiledData_Filtered.csv
%
% To extend the code to different selected data or a different text file,
% generate a function instead of a script.

% Auto-generated by MATLAB on 2016/04/18 20:26:10

%% Initialize variables.
filename = '/Users/Michelle/Research/data/__DATA_ANALYSIS/_ALL_DATA/_Results/_LegsStridesCompiledData_Filtered.csv';
delimiter = ',';
startRow = 2;
...
LegsStridesCompiledDataFiltered = [dataArray{1:end-1}];
%% Clear temporary variables
clearvars filename delimiter startRow formatSpec fileID dataArray ans;

%% SELECT SUBSETS OF DATA

ls_data = LegsStridesCompiledDataFiltered;
